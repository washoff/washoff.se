...
/***/ function(module, exports, __webpack_require__) {
	...
	var _renderer3 = __webpack_require__(23);
	
	var _renderer4 = _interopRequireDefault(_renderer3);
	
	var _renderer5 = __webpack_require__(24);
	
	var _renderer6 = _interopRequireDefault(_renderer5);
	
	var _renderer7 = __webpack_require__(25);
	
	var _renderer8 = _interopRequireDefault(_renderer7);
	...
	var _renderer9 = __webpack_require__(193);
	
	var _renderer10 = _interopRequireDefault(_renderer9);
	
	var _theme = __webpack_require__(194);
	
	var _theme2 = _interopRequireDefault(_theme);
	
	var _johnnyProfile = __webpack_require__(195);
	
	var _johnnyProfile2 = _interopRequireDefault(_johnnyProfile);
	
	var _logotype = __webpack_require__(196);
	...
	function main() {
	  var theme = _theme2.default.create().theme;
	  /* eslint-disable no-magic-numbers */
	  var styles = _aphrodite2.default.StyleSheet.create({
	    app: {
	  ...
	  var HoristontalList = _renderer4.default.create(_react2.default, _aphrodite2.default).render;
	  var HoristontalListItem = _renderer6.default.create(_react2.default, _aphrodite2.default, theme).render;
	  var Link = _renderer8.default.create(_react2.default, _aphrodite2.default, theme).render;
	  var Footer = _renderer2.default.create(_react2.default, _aphrodite2.default, theme, HoristontalList, HoristontalListItem, Link).render;
	  /* TODO: const MainMenu = MainMenuFactory.create(
	    React, Aphrodite, theme, HoristontalList, HoristontalListItem, Link
	  ).render -MANI */
	  var ResponsiveContainer = _renderer10.default.create(_react2.default, _aphrodite2.default, theme).render;
	  _reactDom2.default.render(_react2.default.createElement(
	    'div',
	    { className: _aphrodite2.default.css(styles.app) },
	    _react2.default.createElement(
	      'div',
	      { className: _aphrodite2.default.css(styles.neutralSection) },
	      _react2.default.createElement(
	        ResponsiveContainer,
	        null,
	        _react2.default.createElement('img', { src: _logotype2.default, className: _aphrodite2.default.css(styles.logotype) }),
	        _react2.default.createElement(
	          'h2',
	          { className: _aphrodite2.default.css(styles.quote) },
	    ...
	    _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'p',
	          null,
	          'Med lång erfarenhet inom klottersanering och underhåll av fastigheter så är vi ett av de mest ledande företagen inom klottersanering, skuggsanering samt klotterskydd. Vi hjälper dig att skydda din fastighet eller klottrat område. Vi siktar mot ett renare Sverige fritt från skadegörelse och strävar efter att göra det på ett miljövänligt sätt.'
	        )
	      )
	    ),
	    _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'p',
	          null,
	          'Vi tar bort skuggor som kan finnas kvar efter tidigare saneringar. Vi lägger ner den lilla extra tiden som krävs för att få en 99% borttagning av skadegörelse. Vi har ett brett utbud av tjänster vilket innebär att man kan anlita ett företag för olika typer av arbeten inom underhåll av fastigheter. Efter sanering erbjuder vi också återställning av ytor på de skadade områdena samt klotterskydd som förhindrar större skada vid sanering. Vi är måna om våra kunder och lägger ner kärlek i det arbete vi utför. Ni kommer ställa er frågan, var fanns klottret? Kan en fastighet se så ren ut?'
	        )
	      )
	    ),
	    _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'ul',
	          { className: _aphrodite2.default.css(styles.serviceList) },
	          ['Klotterkonsultering', 'Rivning', 'Klottersanering', 'Lokalstäd', 'Klotterskydd', 'Flyttstäd', 'Taktvätt', 'Byggstäd', 'Fasadtvätt', 'Fordonsstäd', 'Högtryckstvätt', 'Snöskottning'].map(function onMap(serviceName) {
	            return _react2.default.createElement(
	              'li',
	              { key: serviceName, className: _aphrodite2.default.css(styles.serviceListItem) },
	              serviceName
	            );
	          })
	        )
	    ...
	    _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ResponsiveContainer,
	        null,
	        _react2.default.createElement('img', { src: _johnnyProfile2.default, className: _aphrodite2.default.css(styles.profile) }),
	        _react2.default.createElement(
	          'h2',
	          null,
	          'Johnny Arstrand VD på Wash Off'
	        ),
	        _react2.default.createElement(
	          'p',
	          null,
	          'Jag är en person med glimten i ögat och ger det lilla extra till kunden. Jag är målinriktad och ser inga problem utan bara möjligheter. Jag gillar att ha många bollar i luften och när jag gör något så gör jag det till 110%. Jag har lärt mig genom livet att hårt arbete lönar sig och vill alltid göra mitt bästa gentemot kunden. Är en kärleksfull familjefar som gärna sprider min glädje till alla runt omkring mig.'
	        )
	      )
	    ),
...
/***/ function(module, exports) {
	...
	function create(React, _ref, theme, HorizontalList, HorizontalListItem, Link) {
	      ...
	      React.createElement(
	        ...
	        data.map(function onMap(footerItemData) {
	          return React.createElement(
	            ...
	            React.createElement(
	              Link,
	              { linkHref: footerItemData.linkHref },
	              React.createElement(
	                'div',
	                null,
	                React.createElement('i', { className: css(styles.icon) + ' ' + footerItemData.labelIcon })
	              ),
	              React.createElement(
	                'div',
	                null,
...
/***/ function(module, exports) {
	...
	function create(React, _ref, theme) {
	  var StyleSheet = _ref.StyleSheet;
	  var css = _ref.css;
	  ...
	  function render(_ref2) {
	    var children = _ref2.children;
	    var linkHref = _ref2.linkHref;
	
	    return React.createElement(
	      'a',
	      { href: linkHref, className: css(styles.link) },
	      children
	    );
	  }
	  render.propTypes = {
...
/***/ function(module, exports) {
	...
	function injectFontFamilies() {
	  ...
	  wf.async = 'true';
	  var FIRST_ELEMENT = 0;
	  var script = document.getElementsByTagName('script')[FIRST_ELEMENT];
	...
	function create() {
	  ...
	  var theme = {
	    ...
	    secondaryBackgroundGradient: 'linear-gradient(#354458, #313751)',
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "17794a23e874fe364278eeb33ffa1edb.jpg";

/***/ },
/* 196 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "2061f3d6da54734c94cfa3dba900d154.png";
